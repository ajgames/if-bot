...
export default function NotificationsPage() {
    ...
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker
        ...
        .then((serviceWorkerRegistration) => {
          serviceWorkerRef.current = serviceWorkerRegistration;
        });
    }
  }, []);
  ...
  const handlePermissionRequest = async () => {
    ...
    console.log(permission, serviceWorkerRef.current);
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-6">
      <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-md w-full">
        ...
        <p className="text-gray-700 mb-6">
          We'd like to send you notifications so you don't miss out on any
          updates!
        </p>
        {isGranted ? (
          <p className="text-green-500">
            Notifications are enabled! Now just save to your
          </p>
        ) : (
          <button
